		...
		<div class="row">
			<div class="col-12">
				<div class="header__title">
					<h1><span id="text-h1"><?php echo get_theme_mod('wikipress_text_H1'); ?></span> <?php echo get_bloginfo('name'); ?></h1>
				</div>
			</div>
			<div class="col-12">
				<div class="header__input header-input d-flex justify-content-center">
					<input class="header-input__search-field" type="text" placeholder="Keyword, for example, &laquo;Salary&raquo;, &laquo;Promotion&raquo;, &laquo;About the company&raquo;">
